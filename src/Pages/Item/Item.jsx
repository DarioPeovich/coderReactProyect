...
function Item() {
  ...
  const productoAlCarrito = () => {
    ...
    if (!productoExistente) {
      ...
      setShowToast(true);
      setTimeout(() => {    //el setTimeout es para que se vea el Toast, porque si no va al Componente Cart de una y no se ve.
      navigate("/cart");
      }, 2000);
    }
  };
  ...
  return (
    <div>
      ...
      >
        <Toast.Header>
          <strong className="mr-auto">Producto Existente en el carrito de Compras</strong>
        </Toast.Header>
